...
suite() ->
    SchemaName = 'test',
    MetricGrp_1 = #sv_metric_group{id = 1,
                                   schema_name = SchemaName,
                                   name = 'metic_group_1',
                                   created_at = leo_date:now()},
    MetricGrp_2 = #sv_metric_group{id = 2,
                                   schema_name = SchemaName,
                                   name = 'metic_group_2',
                                   created_at = leo_date:now()},
    MetricGrp_3 = #sv_metric_group{id = 3,
                                   schema_name = SchemaName,
                                   name = 'metic_group_3',
                                   created_at = leo_date:now()},
    ...
    not_found = svc_tbl_metric_group:get(MetricGrp_1#sv_metric_group.schema_name,
                                         MetricGrp_1#sv_metric_group.name),
    ...
    {ok, Ret_1} = svc_tbl_metric_group:get(MetricGrp_1#sv_metric_group.schema_name,
                                           MetricGrp_1#sv_metric_group.name),
    {ok, Ret_2} = svc_tbl_metric_group:get(MetricGrp_2#sv_metric_group.schema_name,
                                           MetricGrp_2#sv_metric_group.name),
    {ok, Ret_3} = svc_tbl_metric_group:get(MetricGrp_3#sv_metric_group.schema_name,
                                           MetricGrp_3#sv_metric_group.name),
    not_found = svc_tbl_metric_group:get(SchemaName,'metric_group_4'),
    ...
    ok = svc_tbl_metric_group:delete(MetricGrp_1#sv_metric_group.schema_name,
                                     MetricGrp_1#sv_metric_group.name),
    not_found = svc_tbl_metric_group:get(MetricGrp_1#sv_metric_group.schema_name,
                                         MetricGrp_1#sv_metric_group.name),
